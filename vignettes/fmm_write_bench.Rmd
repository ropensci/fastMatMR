...
<div class="figure">
<img src="fixed-sparse-1.png" alt="plot of chunk fixed-sparse" width="800" />
<p class="caption">plot of chunk fixed-sparse</p>
</div>
...
<div class="figure">
<img src="varying-sparse-1.png" alt="plot of chunk varying-sparse" width="800" />
<p class="caption">plot of chunk varying-sparse</p>
</div>
...
#> [1] ggplot2_3.4.3         microbenchmark_1.4.10 Matrix_1.6-1         
#> [4] fastMatMR_0.0.0.9000  testthat_3.1.10      
#> 
...
#> [17] desc_1.4.2        lifecycle_1.0.3   farver_2.1.1      compiler_4.3.1   
#> [21] stringr_1.5.0     brio_1.1.3        munsell_0.5.0     decor_1.0.2      
#> [25] httpuv_1.6.11     htmltools_0.5.6   usethis_2.2.2     yaml_2.3.7       
#> [29] later_1.3.1       pillar_1.9.0      crayon_1.5.2      urlchecker_1.0.1 
#> [33] ellipsis_0.3.2    cachem_1.0.8      sessioninfo_1.2.2 nlme_3.1-163     
...
#> [65] mgcv_1.9-0        profvis_0.3.8     rlang_1.1.1       Rcpp_1.0.11      
#> [69] xtable_1.8-4      glue_1.6.2        xml2_1.3.5        renv_1.0.2       
#> [73] pkgload_1.3.2.1   rstudioapi_0.15.0 R6_2.5.1          fs_1.6.3
```
