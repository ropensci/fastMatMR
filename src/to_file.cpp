...
[[cpp11::register]] int sparse_to_fmm(cpp11::sexp input, std::string filename) {
    ...
    if (matrix_class == "ddiMatrix") {
        ...
        p_vec =
            cpp11::as_cpp<std::vector<int>>(cpp11::as_sexp(input.attr("p")));
        i_vec =
            cpp11::as_cpp<std::vector<int>>(cpp11::as_sexp(input.attr("i")));
    }
